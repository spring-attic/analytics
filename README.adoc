...
:images-asciidoc: https://raw.githubusercontent.com/spring-cloud-stream-app-starters/analytics/master/spring-cloud-starter-stream-common-analytics/src/test/resrouces
